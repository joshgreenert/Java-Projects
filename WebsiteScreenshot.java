...
jc.setDialogTitle("Select the website_map file from the Github Repo");
...
FileUtils.copyFile(scrFile, new File(path + site + ".png"));

Screenshot screenshot = new AShot().shootingStrategy(ShootingStrategies.viewportPasting(1000))
.takeScreenshot(driver);
ImageIO.write(screenshot.getImage(), "PNG", new File(path + site + ".png"));
...
new UsernamePasswordCredentialsProvider("joshdangdesigns", "queen-KING-spade-1"));
pushCommand.call();
